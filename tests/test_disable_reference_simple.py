...
class TestDisableReferenceBasic(unittest.TestCase):
    ...
    def test_config_files_contain_disable_reference(self):
        ...
        # 检查base_config.py
        base_config_path = os.path.join(project_root, "roll/configs/base_config.py")
        ...
        # 检查dpo_config.py
        dpo_config_path = os.path.join(project_root, "roll/pipeline/dpo/dpo_config.py")
        ...
        # 检查agentic_config.py
        agentic_config_path = os.path.join(project_root, "roll/pipeline/agentic/agentic_config.py")
        ...
        # 检查rlvr_config.py
        rlvr_config_path = os.path.join(project_root, "roll/pipeline/rlvr/rlvr_config.py")
    ...
    def test_pipeline_files_handle_disable_reference(self):
        ...
        # 检查dpo_pipeline.py
        dpo_pipeline_path = os.path.join(project_root, "roll/pipeline/dpo/dpo_pipeline.py")
        ...
        agentic_pipeline_path = os.path.join(project_root, "roll/pipeline/agentic/agentic_pipeline.py")
        ...
        # 检查rlvr_pipeline.py
        rlvr_pipeline_path = os.path.join(project_root, "roll/pipeline/rlvr/rlvr_pipeline.py")
    ...
    def test_disable_reference_logic_consistency(self):
        ...
        for file_path in files_to_check:
            ...
            if "pipeline" in file_path:
                self.assertIn("not self.pipeline_config.disable_reference" or 
                              "not self.disable_reference", content,
